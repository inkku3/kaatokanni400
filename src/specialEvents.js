export const specialEvents = [
  { text: "Ei puhelimia kierrokset! Jokainen laittaa puhelimensa näkyville. Puhelimensa hapuilija juo.", handler: "rounds", roundsName: "EI PUHELIMIA", roundLength: "2"},
  ...
  { text: "Seuraavan kierroksen olet henkilö vasemmalla puolellasi. Jos sinua kutsuu väärin, juo.", handler: "rounds", roundsName: "NIMI MUUTTUI", roundLength: "1"},
  ...
  { text: "'YOU' = juo..", handler: "youtube", videoId: "B6_iQvaIjXw"}
];
